...
left join departamento on departamento.id= profesor.id_profesor
where tipo='profesor'
...
select departamento.nombre as departamento, profesor.id_profesor from departamento
...
inner join persona on profesor.id_departamento = persona.id
