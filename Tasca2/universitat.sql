...
select asignatura.nombre, persona.nombre from asignatura
right  JOIN persona on persona.id=asignatura.id;
...
select curso_escolar.anyo_inicio, persona.nombre from 
